     ...
     <Container>
      ...
      <h1 className='Title'>Quem <span>somos</span></h1>
       ...
       <Right>
        <h1>MoonShop</h1>
         <hr />
        <p>Bem-vindo à [Nome da Loja], sua fonte confiável para aprender a detectar trapaças no Minecraft! Se você é um jogador apaixonado em busca de conhecimento ou um administrador de servidor determinado a manter a integridade do jogo, você veio ao lugar certo.
...
<br></br>
Na [Nome da Loja], acreditamos na importância de educar e capacitar jogadores e administradores para enfrentar desafios relacionados à integridade do jogo. Esteja você começando sua jornada ou buscando aprimorar suas habilidades existentes, estamos aqui para apoiá-lo em cada passo do caminho.
<br></br>
